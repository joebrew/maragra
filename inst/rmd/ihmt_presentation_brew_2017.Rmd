...
break_days_since <- function(days_since){
  out <- ifelse(days_since > 270, '270+',
    ifelse(days_since > 180, '181-270',
...
## Regression discontunity analysis
...
## Descriptive: absenteeism by time from/to intervention (by time_period)
...
## Modeling after matching {.allowframebreaks}
...
- 30-50% reduction in absenteeism in the 6 months after IRS, when administered during malaria season. 

## Implications

- Reduction is large and significant.
- Depending on detailed cost data (pending), IRS may be effective even from a purely financial point of view. 
