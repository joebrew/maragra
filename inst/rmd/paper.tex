...
Regardless of the academic literature on the risk of workers becoming
infected with malaria, the companies running large agricultural
operations in malaria-endemic regions generally consider the disease to
be an important enough threat to workers' health to merit some form of
investment in malaria control (Pluess et al., 2009). Insecticide
fumigation, bednet distribution, test-and-treat clinics, and occasional
educational campaigns are common forms of corporate social
responsibility to combat malaria. A World Bank study on Nigerian
sugarcane cutters found that the simple availability of testing and
treatment increased productivity by 10\% in the weeks following the
provision of services, the conclusion being that both the treatment and
the test result were effective in increasing productivity, the latter
simply increasing the information available which could influence
personal labor allocation decisions (Dillon et al., 2014).

Malaria may disincentivize investment in business in malaria zones. In a
vicious cycle, businesses already in malaria zones may not be
incentivized to invest in malaria control, perhaps because this is seen
as the domain of the public sector (Curtis et al., 2003), or perhaps due
to not knowing the extent to which the benefits in health of that
control will accrue to the business itself.
...
\caption{i. Fumigation activities carried out by Maragra Malaria Control during study period, ii. Distribution of average time between sprayings of households}\label{fig:unnamed-chunk-14}
\end{figure}
...
worker type on risk of malaria. Our econometric model is relatively
straightforward:
...
intervention whether the residence of the worker in question was treated
in the last year, and, if so, the time since treatment (represented
above as the interaction term, where where \(_t\) represents time
elapsed since commencement of the most recent IRS campaign). We define
the malaria season as any time during which the clinical incidence of
malaria in the district of Manhiça was at or greater than the median
clinical incidence of malaria for the entire study period. These weeks
are flagged as red in Figure 1, Panel A. By using clinical incidence of
the area of residence of the workers (as opposed to more typical proxies
for malaria risk, such as only rainy vs.~non rainy season), our
seasonality estimate is a closer approximation of true malaria risk,
incorporating lagged effects such as the incubation period of the
parasite, as well as any inherent non-linear effects of weather. In
addition, we adjust for daily precipitation
...
Variable &   & Workers & (\%) \\ 
  \hline
Department & Administrative & 157 & 4.67 \\ 
   & Factory & 459 & 13.65 \\ 
   & Field & 2746 & 81.68 \\ 
  Sex & F & 1305 & 38.82 \\ 
   & M & 2057 & 61.18 \\ 
  Status & Permanent & 500 & 14.87 \\ 
   & Temporary & 2862 & 85.13 \\ 
  Age & 20 & 985 & 29.30 \\ 
   & 30 & 1244 & 37.00 \\ 
   & 40 & 665 & 19.78 \\ 
   & 50 & 347 & 10.32 \\ 
...
The overall absenteeism rate during the study period was 5.56\% among
all workers. The number of malaria cases registered at the company
clinic during that time was 1873, for an approximate annualized clinical
incidence of 110 cases per 1,000.
...
\caption{Age distribution by sex and worker status}\label{fig:unnamed-chunk-17}
\end{figure}
...
\caption{i. Monthly total precipitation in the Maniça district; ii. Average monthly temperature (bars) during the study period, as well as monthly maximum (red) and minimum (blue) temperatures}\label{fig:unnamed-chunk-18}
\end{figure}

\section{Results}\label{results}

In Southern Mozambique, malaria peaks during the summer months (December
through March) most years (Figure 4, panel A), and worker absenteeism at
...
sick absenteeism have declined in recent years at Maragra (figure 4,
...
largely non-seasonal (figure 4, panels E and F) suggests that a
...
\textbf{Effect of IRS on clinical malaria}: xxx.
...
non-field worker). The reason for segregating models rather than
...
The model results (table 3) suggest a significant decrease in
absenteeism following the administration of IRS. The effect is
ambivalent among temporary workers, whereas among permanent workers the
administration of IRS decreases absenteeism betwen 2.5 and 8.4
percentage points in the 2-9 month following administration. These
effects are consistent with IRS decreasing absence through the medium of
malaria, since (a) the effect is not as strong in the first month
(potentially during the parasite incubation phase), the effect is
...
\caption{\label{tab:unnamed-chunk-23}Models with worker fixed effects}
\centering
\begin{tabular}[t]{ll}
\toprule
Term & Estimate\\
...
\hspace{1em}Months since IRS: 01 & 3.83 (P<0.001)\\
\hspace{1em}Months since IRS: 02-04 & 4.206 (P<0.001)\\
\hspace{1em}Months since IRS: 05-09 & -3.175 (P<0.001)\\
\hspace{1em}Months since IRS: 10+ & -5.775 (P<0.001)\\
\hspace{1em}Malaria season:Months since IRS: 01 & -4.529 (P<0.001)\\
\hspace{1em}Malaria season:Months since IRS: 02-04 & -8.398 (P<0.001)\\
\hspace{1em}Malaria season:Months since IRS: 05-09 & -3.859 (P<0.001)\\
\hspace{1em}Malaria season:Months since IRS: 10+ & 4.507 (P=0.002)\\
\addlinespace[1.5em]
\multicolumn{2}{l}{\textbf{Permanent not field worker}}\\
\hspace{1em}Malaria season & 2.076 (P<0.001)\\
\hspace{1em}Months since IRS: 01 & -2.078 (P<0.001)\\
\hspace{1em}Months since IRS: 02-04 & 3.911 (P<0.001)\\
\hspace{1em}Months since IRS: 05-09 & -0.822 (P=0.089)\\
\hspace{1em}Months since IRS: 10+ & -0.25 (P=0.758)\\
\hspace{1em}Malaria season:Months since IRS: 01 & 2.723 (P<0.001)\\
\hspace{1em}Malaria season:Months since IRS: 02-04 & -5.785 (P<0.001)\\
\hspace{1em}Malaria season:Months since IRS: 05-09 & -2.447 (P<0.001)\\
\hspace{1em}Malaria season:Months since IRS: 10+ & 4.501 (P<0.001)\\
\addlinespace[1.5em]
\multicolumn{2}{l}{\textbf{Temporary field worker}}\\
\hspace{1em}Malaria season & -0.005 (P=0.833)\\
\hspace{1em}Months since IRS: 01 & -0.429 (P<0.001)\\
\hspace{1em}Months since IRS: 02-04 & -0.575 (P<0.001)\\
\hspace{1em}Months since IRS: 05-09 & -0.586 (P<0.001)\\
\hspace{1em}Months since IRS: 10+ & -1.025 (P<0.001)\\
\hspace{1em}Malaria season:Months since IRS: 01 & -0.066 (P=0.725)\\
\hspace{1em}Malaria season:Months since IRS: 02-04 & 0.166 (P=0.274)\\
\hspace{1em}Malaria season:Months since IRS: 05-09 & 0.063 (P=0.654)\\
\hspace{1em}Malaria season:Months since IRS: 10+ & 0.062 (P=0.789)\\
\addlinespace[1.5em]
\multicolumn{2}{l}{\textbf{Temporary not field worker}}\\
\hspace{1em}Malaria season & -0.22 (P=0.294)\\
\hspace{1em}Months since IRS: 01 & -1.466 (P=0.389)\\
\hspace{1em}Months since IRS: 02-04 & 0.571 (P=0.6)\\
\hspace{1em}Months since IRS: 05-09 & -1.018 (P=0.334)\\
\hspace{1em}Months since IRS: 10+ & 10.606 (P<0.001)\\
\hspace{1em}Malaria season:Months since IRS: 01 & 6.093 (P=0.002)\\
\hspace{1em}Malaria season:Months since IRS: 02-04 & 0.476 (P=0.736)\\
\hspace{1em}Malaria season:Months since IRS: 05-09 & -1.505 (P=0.277)\\
\hspace{1em}Malaria season:Months since IRS: 10+ & -10.785 (P<0.001)\\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Translating absences to costs}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ro_data <-}\StringTok{ }\NormalTok{ab_panel }\OperatorTok{%>%}\StringTok{ }\KeywordTok{left_join}\NormalTok{(irs, }\DataTypeTok{by =} \KeywordTok{c}\NormalTok{(}\StringTok{"date"}\NormalTok{, }\StringTok{"unidade"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(days_since }\OperatorTok{<}\StringTok{ }
\StringTok{    }\DecValTok{0}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{pre_irs =} \KeywordTok{between}\NormalTok{(days_since, }\OperatorTok{-}\DecValTok{10}\NormalTok{, }\OperatorTok{-}\DecValTok{1}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# mutate(time_period = lendable::time_period_extract(date)) %>%}
\CommentTok{# mutate(time_period = as.character(time_period)) %>%}
\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{time_period =} \KeywordTok{make_season}\NormalTok{(}\DataTypeTok{date =}\NormalTok{ date)) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{absent_sick =} \KeywordTok{ifelse}\NormalTok{(}\KeywordTok{is.na}\NormalTok{(absent_sick), }
    \OtherTok{FALSE}\NormalTok{, absent_sick)) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{left_join}\NormalTok{(workers }\OperatorTok{%>%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{select}\NormalTok{(oracle_number, }
\NormalTok{    sex, department, permanent_or_temporary), }\DataTypeTok{by =} \StringTok{"oracle_number"}\NormalTok{)}


\NormalTok{make_model <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(}\DataTypeTok{formula =} \StringTok{"absent ~ pre_irs + time_period"}\NormalTok{) \{}
\NormalTok{    ro_model <-}\StringTok{ }\KeywordTok{glm}\NormalTok{(}\KeywordTok{as.formula}\NormalTok{(formula), }\DataTypeTok{data =}\NormalTok{ ro_data, }\DataTypeTok{family =} \KeywordTok{binomial}\NormalTok{(}\StringTok{"logit"}\NormalTok{))}
\NormalTok{    coefs <-}\StringTok{ }\KeywordTok{exp}\NormalTok{(}\KeywordTok{coef}\NormalTok{(ro_model))}
\NormalTok{    ci <-}\StringTok{ }\KeywordTok{confint}\NormalTok{(ro_model)}
\NormalTok{    ci <-}\StringTok{ }\KeywordTok{exp}\NormalTok{(ci)}
\NormalTok{    out <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{Variable =} \KeywordTok{names}\NormalTok{(coefs), }\DataTypeTok{Estimate =}\NormalTok{ coefs, }\DataTypeTok{Lower =}\NormalTok{ ci[, }
        \DecValTok{1}\NormalTok{], }\DataTypeTok{Upper =}\NormalTok{ ci[, }\DecValTok{2}\NormalTok{])}
    \KeywordTok{row.names}\NormalTok{(out) <-}\StringTok{ }\OtherTok{NULL}
\NormalTok{    out}\OperatorTok{$}\StringTok{`}\DataTypeTok{P value}\StringTok{`}\NormalTok{ <-}\StringTok{ }\KeywordTok{coef}\NormalTok{(}\KeywordTok{summary}\NormalTok{(ro_model))[, }\DecValTok{4}\NormalTok{]}
\NormalTok{    out}\OperatorTok{$}\NormalTok{Significant <-}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(out}\OperatorTok{$}\StringTok{`}\DataTypeTok{P value}\StringTok{`} \OperatorTok{<=}\StringTok{ }\FloatTok{0.001}\NormalTok{, }\StringTok{"xxx"}\NormalTok{, }\KeywordTok{ifelse}\NormalTok{(out}\OperatorTok{$}\StringTok{`}\DataTypeTok{P value}\StringTok{`} \OperatorTok{<=}\StringTok{ }
\StringTok{        }\FloatTok{0.01}\NormalTok{, }\StringTok{"xx"}\NormalTok{, }\KeywordTok{ifelse}\NormalTok{(out}\OperatorTok{$}\StringTok{`}\DataTypeTok{P value}\StringTok{`} \OperatorTok{<=}\StringTok{ }\FloatTok{0.05}\NormalTok{, }\StringTok{"x"}\NormalTok{, }\StringTok{""}\NormalTok{)))}
    \KeywordTok{return}\NormalTok{(}\KeywordTok{kable}\NormalTok{(out, }\DataTypeTok{format =} \StringTok{"latex"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{kable_styling}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }\KeywordTok{row_spec}\NormalTok{(}\DataTypeTok{row =} \KeywordTok{which}\NormalTok{(}\KeywordTok{grepl}\NormalTok{(}\StringTok{"pre_irs"}\NormalTok{, }
\NormalTok{        out}\OperatorTok{$}\NormalTok{Variable)), }\DataTypeTok{background =} \StringTok{"yellow"}\NormalTok{))}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
